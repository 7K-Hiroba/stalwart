...
Helm chart for stalwart.

This chart installs the workload (Deployment, Service, HPA, PDB, HTTPRoute). For cross-cutting platform dependencies (secrets, observability, databases), install the companion [stalwart-platform](../platform/README.md) chart.
