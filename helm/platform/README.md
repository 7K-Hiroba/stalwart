...
Platform dependencies for the [stalwart](../base/README.md) chart — provisions the cross-cutting resources the workload needs but that aren't part of its lifecycle.

Install this **alongside** `stalwart`, typically in the same namespace.
...
The chart is split so that **workload-lifecycle** resources (Deployment, HPA, PDB, HTTPRoute) live in [`stalwart`](../base/README.md), while **cross-cutting dependencies** (ESO, ServiceMonitor, dashboards, DB, storage) live here. This keeps each chart focused and lets operators opt out of platform wiring without losing the app.

## Part of the Hiroba ecosystem

Scaffolded with [Hiroba](https://github.com/7K-Hiroba/Hiroba). Source and issues: <https://github.com/7K-Hiroba/stalwart>.
